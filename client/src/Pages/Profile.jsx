...
useEffect(() => {
  ...
  return (
    ...
    <div className="flex items-center md:px-96 p-8 justify-center min-h-screen bg-[#0e0f14] text-white">
      <motion.div
        initial={{ opacity: 0, y: -50 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        className="shadow-lg rounded-lg overflow-hidden max-w-4xl w-full"
      >
