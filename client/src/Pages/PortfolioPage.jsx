...
const PortfolioPage = () => {
    ...
    const StockDetails = async () => {
        setLoading(true);
        try {
            const { data } = await axios.get('https://stockexchangeserver.onrender.com/api/v1/stock/getStockInfo', {
    ...
    const getAiResponse = async () => {
        ...
        setLoading(true);
        try {
            const { data } = await axios.get('https://stockexchangeserver.onrender.com/api/v1/stock/getAiResponse', {
                withCredentials: true
            });
